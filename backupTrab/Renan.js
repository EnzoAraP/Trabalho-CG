...
let camPos = new THREE.Vector3(0, 0.9, 0);
...
function keyboardUpdate() {
   ...
   if (keyboard.pressed("left")) camera.rotateY(rotSpeed);
   if (keyboard.pressed("right")) camera.rotateY(-rotSpeed);
   if (keyboard.pressed("up")) camera.rotateX(rotSpeed);
   if (keyboard.pressed("down")) camera.rotateX(-rotSpeed);
   if (keyboard.pressed("pageup")) camera.rotateZ(-rotSpeed);
   if (keyboard.pressed("pagedown")) camera.rotateZ(rotSpeed);
